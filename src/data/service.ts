...
export const serviceList2 = [
  ...
  },
  {
    ...
    icon: '[AAA]',
    description: `This segment represents a unique identification of the manufacturer or company that produces the product. This short, unique code is assigned to each participant in the OSPI system.`
  },
  {
    id: 3,
    linkUrl: '#',
    ...
    description: `This section specifies the product category, such as food, electronics, or clothing. This makes it easier to sort and search for products in databases and can leverage existing standards`
  },
  {
    id: 4,
    linkUrl: '#',
    title: 'Unique Product Identification:',
    icon: 'uil-laptop-cloud',
    description: `his is the main section of the OSPI code and contains a unique alphanumeric identification for each specific product or product variant. This identification can be generated by companies or the ProductDB.io platform, similar to UUIDs (Universally Unique Identifiers).`
  },
  {
    id: 5,
    linkUrl: '#',
    ...
    icon: 'uil-chart-line',
    description: `This segment denotes specific variations of a product, such as color, size, or flavor. This allows companies to distinguish between different variants within a product line without creating new codes.`
  },
  {
    id: 6,
    linkUrl: '#',
    title: 'Checksum or Control Number:',
    icon: 'uil-chart-line',
    description: `This component is a control number that helps with error detection, which is especially important for manual entry or barcode implementations.`
  }
];
