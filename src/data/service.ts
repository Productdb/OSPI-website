...
export const serviceList2 = [
  {
    ...
    description: `We provide assistance to ensure that your integration with the OSPI system runs smoothly, helping you adopt the standard without any disruption.`
  },
  {
    id: 2,
    linkUrl: '#',
    ...
    description: `Our secure platforms make it easy for you to manage and synchronize product data across multiple systems, ensuring accuracy and reliability throughout the supply chain.`
  },
  {
    id: 3,
    linkUrl: '#',
    title: 'Automated Product Updates',
    icon: 'uil-sync-exclamation',
    description: `Stay on top of changes to your product lines with daily, automated updates. We help ensure that all identifiers, product categories, and variations are kept up-to-date in real-time.`
  },
  {
    id: 4,
    linkUrl: '#',
    title: 'Product Identification Consulting',
    icon: 'uil-comment-lines',
    description: `We offer expert guidance on how to best utilize the OSPI structure to improve product traceability, efficiency, and global compatibility, including customized advice for your specific industry.`
  }
];
