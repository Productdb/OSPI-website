...
<p>OSPI is a beautiful and flawless site template that includes numerous UI elements and features, elegant ready-made blocks and rich pages, and everything else you need to create a unique and professional website. OSPI React landing pages can be used for your React app. It’s super easy to set up and deploy.</p>
...
<li>Thorough <a href="https://OSPI-react.netlify.app/docs" rel="nofollow">help documentation</a> with code snippets
</li>
